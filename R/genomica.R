...
#' @param Predictors example: c('Treatment') - This is the main predictor (independent variable) according to your study design.
...
#' @param P2_levels example: c('Control','Treatment1','Treatment2) - If your main predictor is not a numerical variable, this will set the levels for your main predictor (the model will test the comparisons towards the first term in this vector, such as Control Vs Treatment1 and Control Vs Treatment2 in the example).
